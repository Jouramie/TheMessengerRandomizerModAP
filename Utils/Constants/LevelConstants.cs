...
public static class LevelConstants
{
    ...
    public static readonly Dictionary<string, RandoLevel> EntranceNameToRandoLevel = new Dictionary<string, RandoLevel>
    {
        ...
        { "Catacombs - Top Left", new RandoLevel(ELevel.Level_04_Catacombs, new Vector3(48.5f, -11)) },
        { "Catacombs - Right", new RandoLevel(ELevel.Level_04_Catacombs, new Vector3(809.5f, -74.5f)) },
        { "Catacombs - Bottom", new RandoLevel(ELevel.Level_04_Catacombs, new Vector3(511, -123), EBits.BITS_16) }, // Must be 16
        {
        ...
        { "Howling Grotto - Right", new RandoLevel(ELevel.Level_05_A_HowlingGrotto, new Vector3(584.21f, -123f)) }, // Emerald Golem is here. Scene loaded gets called before the check, but level loaded is after
        {
            "Howling Grotto - Top",
        ...
        { "Glacial Peak - Bottom", new RandoLevel(ELevel.Level_09_A_GlacialPeak, new Vector3(202, -519)) },
        ...
        { "Cloud Ruins - Left", new RandoLevel(ELevel.Level_11_A_CloudRuins, new Vector3(-486f, -57f), EBits.BITS_16) },
        ...
        { "Ruxxtin Surfin'", new RandoLevel(ELevel.Level_15_Surf, new Vector3(-472.191f, 472f), EBits.BITS_8) }, // 8
    ...
    public static readonly Dictionary<Transition, string> TransitionToEntranceName = new Dictionary<Transition, string>
    {
        ...
        { new Transition(ELevel.Level_06_A_BambooCreek, ELevel.Level_05_A_HowlingGrotto), "Howling Grotto - Left" },
        { new Transition(ELevel.Level_05_B_SunkenShrine, ELevel.Level_05_A_HowlingGrotto), "Howling Grotto - Bottom" },
        ...
        { new Transition(ELevel.Level_09_B_ElementalSkylands, ELevel.Level_09_A_GlacialPeak), "Glacial Peak - Left" },
        ...
        { new Transition(ELevel.Level_08_SearingCrags, ELevel.Level_12_UnderWorld), "Underworld - Left" },
        ...
        { new Transition(ELevel.Level_13_TowerOfTimeHQ, ELevel.Level_14_CorruptedFuture), "Corrupted Future" },
    ...
    public static readonly Dictionary<string, string> SpecialConnectionSourceExits = new Dictionary<string, string>
    {
