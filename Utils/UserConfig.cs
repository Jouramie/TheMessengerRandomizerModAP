...
public static class UserConfig
{
    ...
    private static void GenerateConfig(string path)
    {
        configTable = new TomlTable
        {
            ...
            ["port"] = new TomlInteger { Value = 38281 },
            ["slot_name"] = new TomlString { Value = "" },
            ["password"] = new TomlString { Value = "" },
            ...
            ["avoid_color"] = new TomlString { Value = "FA8072", Comment = "Hex ID of the color used for Avoid hints" },
            ...
            {
                Comment =
                    "Whether music should be randomized. Very rudimentary currently.\n"
            ...
            ["message_display_timer"] = new TomlFloat
            {
                Value = 3f,
                Comment =
                    "How long to display message popups and server messages.\n"
            ...
            ["shop_hints"] = new TomlBoolean
            {
                Value = true,
                Comment =
                    "Whether items in the shop should display the item, its importance, and hint it out.\n"
