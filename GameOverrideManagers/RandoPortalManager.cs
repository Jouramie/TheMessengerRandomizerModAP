...
public static class RandoPortalManager
{
    ...
    >
    {
        ...
        new List<List<LevelConstants.RandoLevel>>
        {
            ...
            new List<LevelConstants.RandoLevel>
            {
                new LevelConstants.RandoLevel(
                    ELevel.Level_04_C_RiviereTurquoise,
                    new Vector3(648.5f, -83),
                    EBits.BITS_8
                ),
            },
        },
        new List<List<LevelConstants.RandoLevel>>
        {
            ...
            new List<LevelConstants.RandoLevel>
            {
                ...
                new LevelConstants.RandoLevel(
                    ELevel.Level_09_B_ElementalSkylands,
                    new Vector3(2755.5f, 376),
                    EBits.BITS_8
                ),
    ...
    public static void OpenPortalEvent(
        On.PortalOpeningCutscene.orig_OnOpenPortalEvent orig,
        PortalOpeningCutscene self,
        string eventid
    )
    {
        switch (eventid)
    ...
    public static void Teleport()
    {
        ...
        if (
            !LevelConstants.TransitionToEntranceName.TryGetValue(
                new LevelConstants.Transition(ELevel.Level_13_TowerOfTimeHQ, currentLevel),
                out var portal
            )
        )
        {
